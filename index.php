    ...
    <script type="text/javascript">
      ...
      function initialize() {
        ...
        var myOptions = {
          zoom: 11,
          //minZoom: 10,
          center: new google.maps.LatLng(30.6014,-96.3144),
        ...
        <?php
          $types = Array(
              ...
              Array('consulting', 'Consulting'), 
              Array('investor', 'Investors'),
              Array('design', 'Dev. & Design'),
              Array('attorney', 'Attorneys'),
              Array('event', 'Events'),
              );
          $marker_id = 0;
  ...
  <body>
    ...
    <div class="topbar" id="topbar">
      <div class="wrapper">
        <div class="right">
          <div class="share">
            <a href="https://twitter.com/share" class="twitter-share-button" data-lang="en" data-text="Let's put Bryan/College Station startups on the map:" data-via="BCSStartup" data-count="none">Tweet</a>
            <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
          
            <iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.bcsstartup.com&amp;width=72&amp;height=21&amp;colorscheme=light&amp;layout=button_count&amp;action=like&amp;show_faces=false&amp;send=false&amp;appId=166214746897829" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:72px; height:21px;" allowTransparency="true"></iframe>
...
WHERE start_date >  ".time()." AND start_date <".(time()+4838400)." ");
    ...
    <div class="modal hide" id="modal_info">
      ...
      <div class="modal-body">
        <p>
          We built this map to connect and promote the startup community
          in Bryan/College Station. We've seeded the map but we need
          ...
          <?php } ?>
          Let's put Bryan/College Station on the map together!
        </p>
        <p>
          Questions? Feedback? Connect with us: <a href="http://www.twitter.com/BCSStartup" target="_blank">@BCSStartup</a>
        </p>
        
        <p>
          This map was built with <a href="https://github.com/abenzer/represent-map">RepresentMap</a> - an open source project 
